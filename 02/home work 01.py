...
#user_input_2 = int( input("Введите скидку:"))
...
#print( user_cifra_1 % 10)

#Задание №6 "Периметр прямоугольника"
#print("Периметр прямоугольника")

#user_dolgota_1 = int( input("Введите длинну:"))
#user_shirota_2 = int( input("Введите ширину:"))

#print("Периметр прямоугольника равен:", int( 2* (user_dolgota_1 + user_shirota_2)))
